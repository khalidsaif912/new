...
{CHIP_ICON_CSS}
    ...
    /* للشاشات المتوسطة والموبايل: صف واحد بدون تمديد شكل البطاقة */
    ...
    /* للموبايل (يشمل شاشات ~6.1 إنش): نفس شكل البطاقة السابق */
    @media (max-width:600px){{
      ...
      .summaryChip .chipVal {{ font-size:18px; height:24px; }}
      .summaryChip .chipVal .chip-icon {{ width:20px; height:20px; }}
      .summaryChip .chipLabel {{ font-size:8.5px; letter-spacing:.2px; margin-top:4px; }}
    }}
...
{SHIFT_COPY_CSS}
    ...
    @media (max-width:480px){{
      ...
      .summaryChip .chipLabel {{ font-size:8px; }}
    }}
