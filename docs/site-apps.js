...
(function () {
  ...
  function injectCompactStyles() {
    ...
    style.textContent = [
      ...
      '.spotlightSheet{position:fixed;inset:0;display:none;align-items:center;justify-content:center;background:rgba(15,23,42,.45);padding:16px;padding-bottom:max(16px,env(safe-area-inset-bottom,0px));z-index:100130;pointer-events:none;visibility:hidden;}',
