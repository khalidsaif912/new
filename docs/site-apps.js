...
(function () {
  ...
  function injectCompactStyles() {
    ...
    style.textContent = [
      ...
      '.spotlightBar .spotlightBtn--wa{position:relative!important;background:linear-gradient(135deg,#ecfdf5 0%,#dcfce7 100%)!important;border:1.5px solid #86efac!important;box-shadow:0 8px 18px rgba(22,163,74,.12)!important;animation:spotlightWaPulse 1.8s ease-in-out infinite!important;overflow:hidden!important;}',
      ...
      '@keyframes spotlightWaPulse{0%,100%{transform:translateY(0) scale(1)}50%{transform:translateY(-1px) scale(1.01)}}',
