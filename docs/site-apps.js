...
(function () {
  ...
  function injectCompactStyles() {
    ...
    style.textContent = [
      ...
      '.spotlightBar .spotlightBtn--wa{position:relative!important;background:linear-gradient(135deg,#ecfdf5 0%,#dcfce7 100%)!important;border:1.5px solid #86efac!important;box-shadow:0 10px 24px rgba(22,163,74,.14)!important;animation:spotlightWaPulse 1.8s ease-in-out infinite!important;overflow:hidden!important;}',
      '.spotlightBar .spotlightBtn--wa::after{content:"' + t('waBadge') + '"!important;position:absolute!important;top:7px!important;inset-inline-end:9px!important;background:#f97316!important;color:#fff!important;font-size:9px!important;font-weight:900!important;padding:4px 7px!important;border-radius:999px!important;box-shadow:0 4px 10px rgba(249,115,22,.28)!important;}',
      '.spotlightBar .spotlightBtn--wa::before{content:""!important;position:absolute!important;inset:-40% auto -40% -35%!important;width:52px!important;background:linear-gradient(90deg,transparent,rgba(255,255,255,.58),transparent)!important;transform:rotate(18deg)!important;animation:spotlightWaShine 2.6s ease-in-out infinite!important;}',
      '@keyframes spotlightWaPulse{0%,100%{transform:translateY(0) scale(1)}50%{transform:translateY(-1px) scale(1.018)}}',
      '@keyframes spotlightWaShine{0%{left:-35%}55%{left:120%}100%{left:120%}}',
      ...
      '@media (max-width:720px){#spotlightEmojiBtn{width:34px;height:34px;}#spotlightEmojiBtn img{width:24px;height:24px;}}',
