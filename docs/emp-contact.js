(function () {
  ...
  function injectStyles() {
    ...
    st.textContent = [
      ...
      '.empContactActs{',
      'display:inline-flex;flex-wrap:wrap;align-items:center;justify-content:flex-start;',
      'gap:8px;min-height:32px;flex:0 0 auto;',
      '}',
      '.empContactAct{',
      ...
      '.empContactAct svg{display:block}',
