(function () {
  ...
  function injectStyles() {
    ...
    st.textContent = [
      ...
      '}',
      '.empContactShiftCode{color:#64748b;flex:0 0 auto;font-weight:700}',
      '.empContactShiftCode.is-today{',
      'color:#0369a1;font-weight:900;font-size:12px;',
      'background:rgba(14,165,233,.14);border:1px solid rgba(14,165,233,.35);',
      'border-radius:6px;padding:1px 5px;line-height:1.35;',
      '}',
      '.empContactShiftSep{',
      'color:#0284c7;font-weight:900;font-size:14px;line-height:1;',
      'padding:0 1px;flex:0 0 auto;opacity:1;',
      '}',
