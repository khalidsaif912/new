(function () {
  ...
  function injectStyles() {
    ...
    st.textContent = [
      ...
      '}',
      '.empContactShiftCode{color:#94a3b8;flex:0 0 auto;font-weight:700}',
      '.empContactShiftCode.is-today{',
      'color:#0f766e;font-weight:900;font-size:12.5px;',
      'letter-spacing:.02em;',
      'text-decoration:underline;text-decoration-thickness:2px;',
      'text-underline-offset:3px;text-decoration-color:#14b8a6;',
      '}',
      '.empContactShiftSep{',
      'color:#38bdf8;font-weight:900;font-size:13px;line-height:1;',
      'padding:0 1px;flex:0 0 auto;opacity:.9;',
      '}',
