...
.footerShare{margin-top:4px;display:flex;justify-content:center;padding:0 12px 4px}
.trainingShareBtn{
...
<script defer src="{'../../training-new-badge.js?v=20260729f' if in_archive else '../training-new-badge.js?v=20260729f'}"></script>
</body>
</html>
'''
    return page
